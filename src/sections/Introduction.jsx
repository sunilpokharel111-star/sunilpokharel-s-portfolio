...
export default function Introduction() {
  return (
    <section id="introduction" className="overlay-bg min-h-screen flex items-center justify-center px-4 sm:px-6 py-20 md:py-0 relative">
      <motion.div
      ...
      >
        <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-4">Hello, I'm Sunil!</h2>
        <h3 className="text-lg sm:text-xl md:text-2xl mb-6">Turning ideas into real digital experiences</h3>
